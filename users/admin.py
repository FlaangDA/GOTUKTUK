...
from forms.register import RegistrationFormCustomer, RegistrationFormCustomerDetails, RegistrationFormDriver, RegistrationFormDriverDetails
...
class DriverInline(admin.StackedInline):
	...
	add_form = RegistrationFormDriverDetails

	formset = inlineformset_factory(CustomUser, DriverDetails, fields=('phone', 'facebookurl', 'profile_pic'))

	#exclude = ('lon', 'lat', 'hasTripRequest', 'available',)

	verbose_name_plural = "Driver Details"

	fields = ('phone', 'facebookurl', 'profile_pic', )
...
class UserAdmin(BaseUserAdmin):
	...
	form = RegistrationFormDriver
	add_form = RegistrationFormDriver
	...
	add_fieldsets = ((None, {'classes': ('wide',),'fields': ('email', 'firstname', 'lastname', 'password1', 'password2' ,'dob', 'date_joined', 'user_type', 'is_active',)}),)
	search_fields = ('email',)
	ordering = ('email',)
	filter_horizontal = ()
